...
execute as @a[scores = {wearingPower = 1, powerHpLoss = 1}] run effect give @s minecraft:strength 1 0 true
execute as @a[scores = {wearingPower = 1, powerHpLoss = 2}] run effect give @s minecraft:strength 1 1 true
execute as @a[scores = {wearingPower = 1, powerHpLoss = 3}] run effect give @s minecraft:strength 1 2 true
execute as @a[scores = {wearingPower = 1, powerHpLoss = 4}] run effect give @s minecraft:strength 1 3 true
execute as @a[scores = {wearingPower = 1, powerHpLoss = 5}] run effect give @s minecraft:strength 1 4 true
