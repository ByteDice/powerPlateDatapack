...
execute as @a[nbt = {SelectedItem: {id: "minecraft:carrot_on_a_stick", components: {"minecraft:custom_data":{activator: 1b}}}}, scores = {usedCOAS = 1.., powerPlateCooldown = 0}] unless entity @s[scores = {inSpawn = 1, isStaff = 0}] run scoreboard players set @s usedAbility 1
