...
execute at @e[scores = {craftAnimationTime = 20..25}] run playsound block.beacon.activate player @a
execute at @e[scores = {craftAnimationTime = 20..80}] run particle electric_spark ~0.5 ~ ~ 0.0 1 0.0 3 0
execute at @e[scores = {craftAnimationTime = 20..80}] run particle electric_spark ~ ~ ~0.5 0.0 1 0.0 3 0
execute at @e[scores = {craftAnimationTime = 20..80}] run particle electric_spark ~-0.5 ~ ~ 0.0 1 0.0 3 0
execute at @e[scores = {craftAnimationTime = 20..80}] run particle electric_spark ~ ~ ~-0.5 0.0 1 0.0 3 0

execute at @e[scores = {craftAnimationTime = 80}] run playsound entity.generic.explode player @a
